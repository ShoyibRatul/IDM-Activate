...
call :_color %Green% "IDM Trial successfully reset."
) else (
call :_color %Red% "Failed IDM Trial successfully reset."
)
...
set "reg=HKCU\SOFTWARE\DownloadManager /v Serial /t REG_SZ /d "629U7-XLT5H-6SCGJ-2CENZ"" & call :_rcont
